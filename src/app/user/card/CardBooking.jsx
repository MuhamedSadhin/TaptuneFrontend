...
export default function CardBooking() {
  ...
  const { mutate } = useCreateCardOrderAndProfile();
  const { mutate: createReviewCardOrder } = useCreateReviewCardOrder();
  ...
  const validate = () => {
    ...
    if (isReviewCard) {
      ...
      if (!formData.googleReviewUrl.trim())
        newErrors.googleReviewUrl = "Google review URL is required";
    } else {
      ...
      if (isReviewCard) {
        createReviewCardOrder(
          ...
          },
          {
            onSuccess: (res) => {
              if (res?.success) {
                toast.success("Review card order placed successfully!");
                navigate(-1);
              } else {
            ...
            <div className="">
              <Card className="border-0 shadow-xl rounded-2xl">
                <CardContent className="p-6 sm:p-8 space-y-8">
                  ...
                  {/* ================= TOTAL ================= */}
                  <div className="bg-gray-50 p-4 rounded-lg flex justify-between font-bold">
