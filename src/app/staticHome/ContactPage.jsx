...
//                           className="inline-block mt-5 px-6 py-3 text-sm font-medium bg-mindaro text-raisin-black rounded-md hover:bg-mindaro-600"
//                         >
//                           Send enquirie
//                         </button>
//                       </div>
...
//                 <Link to={'/'} className='bg-mindaro text-raisin-black px-5 py-4 mt-8 rounded-full hover:bg-white hover:text-raisin-black transition-all duration-300'>Go to home</Link> */}
//           </div>
//         </div>
